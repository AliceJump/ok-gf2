...
> Game terms in this document use the wording shown by the **Global / Steam** client. The feature
> list is also organized around what the program actually ships, so it does not map one-to-one onto
> the Chinese README. See [docs/glossary.md](docs/glossary.md) for the full term mapping.
